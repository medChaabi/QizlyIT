...
*   **`Resource/`** : Placez tous les documents PDF ou matériaux de référence ici.
*   **`QizlyJSON/`** : Placez tous les fichiers `.json` compatibles avec l'application Qizly ici.
...
3. **Ajoutez vos fichiers** : Enregistrez vos fichiers dans les dossiers appropriés.
4. **Mettez à jour le tableau du README.md** :
   - Ajoutez une nouvelle ligne à la Table des Ressources.
   - Exemple de format pour une ligne :
     ```markdown
...
- [ ] Le tableau du `README.md` est mis à jour correctement.
